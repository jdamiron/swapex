	...
	describe('sending tokens', () => {
		...
		describe('failure', async () => {
			it('rejects insufficient balances', async () => {
				...
				await token.transfer(reciever, invalidAmount, { from: reciever }).should.be.rejectedWith(EVM_REVERT);
			})
	...
	describe('delegated token transfers', () => {
		...
		describe('failure', async () => {
			it('rejects insufficient amounts', async () => {
				...
				await token.transfer(reciever, invalidAmount, { from: exchange }).should.be.rejectedWith(EVM_REVERT);
			})
